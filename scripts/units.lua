	...
	BuildingRules = {
		{
			...
			"distance", { Distance = 3, DistanceType = ">", Type = "unit-brising-town-hall"},
			"distance", { Distance = 3, DistanceType = ">", Type = "unit-brising-stronghold"},
...
DefineUnitType("unit-template-spearman", { Name = _("Spearman"),
	Parent = "unit-template-infantry",
	Class = "spearman",
	Costs = {"time", 50, "gold", 420, "lumber", 40},
