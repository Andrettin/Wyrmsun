...
DefineUnitType("unit-template-fauna-unit", { Name = _("Fauna Unit"),
...
DefineUnitType("unit-template-sapient-unit", { Name = _("Sapient Unit"),
	...
	Charisma = 10,
	organic = true,
	Traits = {"upgrade-clumsy", "upgrade-cruel", "upgrade-dim", "upgrade-dextrous", "upgrade-keen", "upgrade-limping", "upgrade-mighty", "upgrade-near-sighted", "upgrade-old", "upgrade-pious", "upgrade-quick", "upgrade-reckless", "upgrade-resilient", "upgrade-slow", "upgrade-strong", "upgrade-weak", "upgrade-wise"}
})
