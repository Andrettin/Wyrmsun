...
DefineUnitType("unit-mercenary-camp", { Name = _("Mercenary Camp"),
	...
	BurnPercent = 50,
	BurnDamageRate = 1,
	Affixes = {"upgrade-item-prefix-impregnable", "upgrade-item-prefix-sturdy"},
	Sounds = {
		"selected", "click",
...
DefineUnitType("unit-template-infantry", { Name = _("Infantry"),
	...
	Traits = {"upgrade-mighty", "upgrade-strong", "upgrade-weak", "upgrade-dextrous", "upgrade-clumsy", "upgrade-reckless", "upgrade-near-sighted", "upgrade-keen", "upgrade-limping", "upgrade-old", "upgrade-quick", "upgrade-resilient", "upgrade-slow", "upgrade-cruel"},
	DropAffixes = {"upgrade-item-prefix-accurate", "upgrade-item-prefix-cruel", "upgrade-item-prefix-sturdy", "upgrade-item-prefix-swift", "upgrade-item-suffix-of-accuracy"},
	ShieldAnimation = {
		{
			"frame", 0,
			"overlay-frame", 0
...
DefineUnitType("unit-template-siege-engine", { Name = _("Siege Engine"),
	...
	TileSize = {1, 1}, BoxSize = {63, 63},
	SightRange = 9,
	BasicDamage = 80, Missile = "missile-catapult-sandstone-rock",
...
DefineUnitType("unit-template-town-hall", { Name = _("Town Hall"),
	...
	BurnDamageRate = 1,
	SelectableByRectangle = true,
	Affixes = {"upgrade-item-prefix-impregnable", "upgrade-item-prefix-industrious", "upgrade-item-prefix-sturdy", "upgrade-item-suffix-of-diligence"},
...
DefineUnitType("unit-template-stronghold", { Name = _("Stronghold"),
	...
	SelectableByRectangle = true,
	Drops = {"unit-wood-pile"},
	AiDrops = {"unit-hammer", "unit-mining-pick", "unit-amulet", "unit-ring"}, -- worker-related items, as well as those we would expect a center of administration to have; and military ones, since this is a stronghold
...
DefineUnitType("unit-template-watch-tower", { Name = _("Watch Tower"),
	...
	TechnologyPointCost = 1,
	SelectableByRectangle = true,
	Affixes = {"upgrade-item-prefix-impregnable", "upgrade-item-prefix-sturdy", "upgrade-item-suffix-of-the-colossus"},
	Sounds = {
