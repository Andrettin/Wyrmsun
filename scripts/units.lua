...
Units = {
	...
	"unit-forest-gnomish-worker", "unit-forest-gnomish-recruit", "unit-forest-gnomish-duelist", "unit-forest-gnomish-master-at-arms", "unit-forest-gnomish-herbalist",
...
DefineUnitType("unit-gold-mine", {
	...
	Icon = "icon-gold-mine",
--	Costs = {"time", 200, "metal", 700, "lumber", 450},
...
DefineUnitType("unit-template-spearman", { Name = _("Spearman"),
	Parent = "unit-template-infantry",
	Class = "spearman",
	Costs = {"time", 50, "metal", 400, "lumber", 100},
...
DefineUnitType("unit-template-archer", { Name = _("Shooter"),
	Parent = "unit-template-sapient-unit",
	Class = "shooter",
	Costs = {"time", 70, "metal", 500, "lumber", 150},
	Dexterity = 11,
	Speed = 10,
	HitPoints = 40,
	TileSize = {1, 1}, BoxSize = {31, 31},
...
DefineUnitType("unit-template-veteran-shooter", {
	...
	Costs = {"time", 105, "metal", 750, "lumber", 225},
	Strength = 11,
	Dexterity = 12,
	Intelligence = 11,
	Charisma = 11,
...
DefineUnitType("unit-template-heroic-shooter", { Name = _("Heroic Shooter"),
	...
	Costs = {"time", 140, "metal", 1000, "lumber", 300},
	Strength = 12,
	Dexterity = 13,
	Intelligence = 12,
	Charisma = 12,
...
DefineUnitType("unit-template-flying-rider", { Name = _("Flying Rider"),
	Parent = "unit-template-sapient-unit",
	Class = "flying-rider",
	Costs = {"time", 250, "metal", 1750, "lumber", 750},
	Strength = 12,
	Dexterity = 13,
	Intelligence = 12,
	Charisma = 12,
...
--	Costs = {"time", 70, "metal", 600, "lumber", 200, "oil", 500},
	Costs = {"time", 70, "metal", 600, "lumber", 2100},
	Speed = 10,
	HitPoints = 150,
	MaxOnBoard = 3,
	TileSize = {2, 2}, BoxSize = {63, 63},
...
DefineUnitType("unit-template-town-hall", {
	...
	Parent = "unit-template-building",
	Class = "town-hall",
	Costs = {"time", 255, "metal", 1200, "lumber", 2400},
	RepairHp = 4,
	RepairCosts = {"metal", 1, "lumber", 1},
	...
	BuilderOutside = true,
	CanStore = {"metal", "gold", "silver", "copper", "lumber", "stone", "coal"},
...
DefineUnitType("unit-template-stronghold", {
	...
	Class = "stronghold",
	Costs = {"time", 200, "metal", 2000, "lumber", 2100, "stone", 1500},
	RepairCosts = {"metal", 1, "lumber", 1, "stone", 1},
...
DefineUnitType("unit-template-farm", {
	...
	Parent = "unit-template-building",
	Class = "farm",
	Costs = {"time", 100, "metal", 500, "lumber", 750},
	RepairHp = 4,
	RepairCosts = {"metal", 1, "lumber", 1},
	Construction = "construction-land",
	Speed = 0,
...
DefineUnitType("unit-template-barracks", {
	...
	Parent = "unit-template-building",
	Class = "barracks",
	Costs = {"time", 200, "metal", 700, "lumber", 1350},
	RepairHp = 4,
	RepairCosts = {"metal", 1, "lumber", 1},
	Construction = "construction-land",
	Speed = 0,
...
DefineUnitType("unit-template-lumber-mill", {
	...
	Parent = "unit-template-building",
	Class = "lumber-mill",
	Costs = {"time", 150, "metal", 600, "lumber", 1350},
	RepairHp = 4,
	RepairCosts = {"metal", 1, "lumber", 1},
...
DefineUnitType("unit-template-smithy", {
	...
	Parent = "unit-template-building",
	Class = "smithy",
--	Costs = {"time", 200, "metal", 800, "lumber", 450, "oil", 100},
	Costs = {"time", 200, "metal", 800, "lumber", 1650},
	RepairHp = 4,
	RepairCosts = {"metal", 1, "lumber", 1},
	Construction = "construction-land",
	Speed = 0,
...
DefineUnitType("unit-template-stables", {
	...
	Parent = "unit-template-building",
	Class = "stables",
	Costs = {"time", 150, "metal", 1000, "lumber", 900},
	RepairHp = 4,
	RepairCosts = {"metal", 1, "lumber", 1},
	Construction = "construction-land",
	Speed = 0,
...
DefineUnitType("unit-template-temple", {
	...
	Parent = "unit-template-building",
	Class = "temple",
	Costs = {"time", 175, "metal", 900, "lumber", 1500},
	RepairHp = 4,
	RepairCosts = {"metal", 1, "lumber", 1},
	Construction = "construction-land",
	Speed = 0,
...
DefineUnitType("unit-template-dock", {
	...
	Parent = "unit-template-building",
	Class = "dock",
	Costs = {"time", 200, "metal", 800, "lumber", 1350},
	RepairHp = 4,
	RepairCosts = {"metal", 1, "lumber", 1},
...
DefineUnitType("unit-dungeon-wall", {
	...
	Costs = {"time", 30, "metal", 20, "lumber", 30},
