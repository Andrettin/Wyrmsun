...
DefineUnitType("unit-gold-mine", {
	...
	Class = "gold_mine",
	Civilization = "neutral",
	Description = "Gold is a crucial metal for most societies, as it serves both as a durable stock of value, and as a means of exchange with which a myriad of goods and services can be traded for: Gold is converted to copper at a 400% ratio.",
...
DefineUnitType("unit-silver-mine", {
	...
	Class = "silver_mine",
	Civilization = "neutral",
	Description = "Silver is a crucial metal for most societies, as it serves both as a durable stock of value, and as a means of exchange with which a myriad of goods and services can be traded for. Although not as valuable as gold, silver is still a highly sought-after metal: Silver is converted to copper at a 200% ratio.",
...
DefineUnitType("unit-copper-mine", {
	...
	Class = "copper_mine",
	Civilization = "neutral",
	Description = "More common than either gold or silver, copper has a multitude of uses. It not only serves as a stock of value and means of exchange, but also as a material for utensils and as an ingredient to the making of bronze: the basic unit of currency.",
...
DefineUnitType("unit-iron-mine", {
	...
	Class = "iron_mine",
	Civilization = "neutral",
	Description = "Iron is a relatively common metal, but working it requires a substantially higher degree of knowledge of metallurgy than working metals like copper, silver or gold: Iron is converted to copper at a 100% ratio.",
...
DefineUnitType("unit-mithril-mine", {
	...
	Class = "mithril_mine",
	Civilization = "neutral",
	Description = "Of the inhabited worlds, mithril is only found in Nidavellir, and even there it is an exceedingly rare metal. Both lighter and more resistant than iron, mithril is highly sought-after for crafting weapons and armor, though its enormous expense ensures that only very few can afford it: Mithril is converted to copper at a 800% ratio.",
...
DefineUnitType("unit-coal-mine", {
	...
	Class = "coal_mine",
	Civilization = "neutral",
	Description = "Coal is a valuable heating material: a quest objective resource.",
...
DefineUnitType("unit-emerald-deposit", {
	...
	Parent = "unit-template-deposit",
--	Description = "Emerald deposits contain deep sources of emeralds, which can be gainfully mined after the proper infrastructure is put into place: Emerald is converted to copper at a 600% ratio.",
...
DefineUnitType("unit-emerald-mine", {
	...
	Class = "emerald_mine",
	Civilization = "neutral",
--	Description = "Emeralds are valuable gems, and can be mined for high profits: Emerald is converted to copper at a 600% ratio.",
