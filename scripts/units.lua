...
DefineUnitType("unit-template-heroic-infantry", { Name = _("Heroic Infantry"),
	...
	organic = true,
	SelectableByRectangle = true,
	DropAffixes = {"upgrade-item-suffix-of-power", "upgrade-item-suffix-of-regeneration", "upgrade-item-suffix-of-swiftness", "upgrade-item-suffix-of-victory", "upgrade-item-suffix-of-vision"}
} )
