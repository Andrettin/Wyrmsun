...
DefineUnitType("unit-log", { Name = "Log",
	...
	TileSize = {1, 1}, BoxSize = {31, 31},
	SightRange = 0,
	BasicDamage = 0, Armor = 2, Missile = "missile-none",
	Priority = 0,
	Type = "land",
	NumDirections = 1,
	VisibleUnderFog = true,
...
DefineUnitType("unit-template-infantry", { Name = _("Infantry"),
	...
	SelectableByRectangle = true,
	Traits = {"upgrade-mighty", "upgrade-strong", "upgrade-weak", "upgrade-dextrous", "upgrade-clumsy", "upgrade-reckless", "upgrade-near-sighted", "upgrade-keen", "upgrade-limping", "upgrade-old", "upgrade-quick", "upgrade-resilient", "upgrade-slow", "upgrade-cruel"},
	DropAffixes = {"upgrade-item-prefix-cruel", "upgrade-item-prefix-sturdy", "upgrade-item-prefix-swift"},
	ShieldAnimation = {
		{
			"frame", 0,
			"overlay-frame", 0
...
DefineUnitType("unit-template-veteran-infantry", { Name = _("Veteran Infantry"),
	...
	organic = true,
	SelectableByRectangle = true,
	DropAffixes = {"upgrade-item-prefix-impregnable", "upgrade-item-prefix-penetrating", "upgrade-item-prefix-vicious", "upgrade-item-prefix-wounding", "upgrade-item-suffix-of-perfuration", "upgrade-item-suffix-of-thorns"}
} )
...
DefineUnitType("unit-template-archer", { Name = _("Archer"),
	...
	TileSize = {1, 1}, BoxSize = {31, 31},
	SightRange = 5,
	BasicDamage = 9, Missile = "missile-arrow",
	MaxAttackRange = 5,
	Accuracy = 10,
	Evasion = 10,
	Priority = 55,
...
DefineUnitType("unit-template-cavalry", { Name = _("Cavalry"),
	...
	Traits = {"upgrade-mighty", "upgrade-strong", "upgrade-weak", "upgrade-dextrous", "upgrade-clumsy", "upgrade-reckless", "upgrade-near-sighted", "upgrade-keen", "upgrade-limping", "upgrade-old", "upgrade-quick", "upgrade-resilient", "upgrade-slow", "upgrade-cruel"},
	DropAffixes = {"upgrade-item-prefix-cruel", "upgrade-item-prefix-impregnable", "upgrade-item-prefix-penetrating", "upgrade-item-prefix-sturdy", "upgrade-item-prefix-swift", "upgrade-item-prefix-vicious", "upgrade-item-prefix-wounding", "upgrade-item-suffix-of-perfuration", "upgrade-item-suffix-of-thorns"},
	Sounds = {
		"step", "step-dirt",
		"step-dirt", "step-dirt",
		"step-gravel", "step-gravel",
...
DefineUnitType("unit-template-flying-rider", { Name = _("Flying Rider"),
	...
	TechnologyPointCost = 1,
	Traits = {"upgrade-mighty", "upgrade-strong", "upgrade-weak", "upgrade-dextrous", "upgrade-clumsy", "upgrade-reckless", "upgrade-near-sighted", "upgrade-keen", "upgrade-limping", "upgrade-old", "upgrade-quick", "upgrade-resilient", "upgrade-slow", "upgrade-cruel"},
	DropAffixes = {"upgrade-item-prefix-cruel", "upgrade-item-prefix-impregnable", "upgrade-item-prefix-penetrating", "upgrade-item-prefix-sturdy", "upgrade-item-prefix-swift", "upgrade-item-prefix-vicious", "upgrade-item-prefix-wounding", "upgrade-item-suffix-of-perfuration", "upgrade-item-suffix-of-thorns", "upgrade-item-suffix-of-victory"},
	Sounds = {
	}
} )
...
DefineUnitType("unit-template-stronghold", { Name = _("Stronghold"),
	Class = "stronghold",
	Animations = "animations-building", 
	Costs = {"time", 200, "gold", 2200, "lumber", 550, "stone", 550},
	RepairHp = 4,
	RepairCosts = {"gold", 1, "lumber", 1, "stone", 1},
	Construction = "construction-land",
	Speed = 0,
...
DefineUnitType("unit-template-watch-tower", { Name = _("Watch Tower"),
	Class = "watch-tower",
	Animations = "animations-building",
	Costs = {"time", 60, "gold", 550, "lumber", 100, "stone", 100},
	RepairHp = 4,
	RepairCosts = {"gold", 1, "lumber", 1, "stone", 1},
	Construction = "construction-land",
	Speed = 0,
...
DefineUnitType("unit-template-guard-tower", { Name = _("Guard Tower"),
	Class = "guard-tower",
	Animations = "animations-building",
	Costs = {"time", 140, "gold", 500, "lumber", 75, "stone", 75},
	RepairHp = 4,
	RepairCosts = {"gold", 1, "lumber", 1, "stone", 1},
	Construction = "construction-land",
	Speed = 0,
