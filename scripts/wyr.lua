...
function CreateUnit(unittype, player, pos)
  ...
  -- Don't add any units in watcher mode for the human player
--  if (GameSettings.GameType == 5 and player == 0) then
--    return
--  end
...
--    if (GameSettings.NumUnits == 1 and not (GameSettings.GameType == 5 and player == 0)) then
