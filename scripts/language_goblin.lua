...
DefineLanguageWord("Fal", { -- from Wesnoth
	...
	Type = "noun",
	Meanings = {},
	NameTypes = {"person-male"} -- example: "Fal Khag" (from Wesnoth)
})
...
DefineLanguageWord("Gom", { -- from Mike Anderson's Tyrant
	...
	Type = "noun",
	Meanings = {},
	AffixNameTypes = {"compound", "prefix", "singular", "person-male"}
})
...
DefineLanguageWord("T'shar", { -- from Wesnoth
	...
	Type = "noun",
	Meanings = {},
	NameTypes = {"person-male"} -- example: T'shar Lggi (from Wesnoth)
})
