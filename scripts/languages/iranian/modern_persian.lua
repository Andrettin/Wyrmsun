...
DefineLanguageWord("Ghund", { -- Source: Carl D. Buck, "Words for 'Battle,' 'War,' 'Army,' and 'Soldier'", 1919, p. 10.
	Language = "modern-persian",
	Type = "noun",
	Meanings = {"Crowd"}
})

DefineLanguageWord("Jang", { -- Source: Carl D. Buck, "Words for 'Battle,' 'War,' 'Army,' and 'Soldier'", 1919, p. 7.
	Language = "modern-persian",
	Type = "noun",
	Meanings = {"Battle", "War"}
})
