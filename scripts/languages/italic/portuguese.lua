...
DefineLanguageWord("Armada", { -- Source: Carl D. Buck, "Words for 'Battle,' 'War,' 'Army,' and 'Soldier'", 1919, p. 13.
	Language = "portuguese",
	Type = "noun",
...
DefineLanguageWord("Hoste", { -- Source: Carl D. Buck, "Words for 'Battle,' 'War,' 'Army,' and 'Soldier'", 1919, p. 12.
	Language = "portuguese",
	Type = "noun",
	Meanings = {"Army"},
