...
DefineLanguageWord("Argans", { -- Source: H. H. Howorth, "The Ethnology of Germany, Part II: The Germans of Caesar", 1878, p. 217.
	Language = "cornish",
	Type = "noun",
	Meanings = {"Silver"}
})

DefineLanguageWord("Bresel", { -- Source: Carl D. Buck, "Words for 'Battle,' 'War,' 'Army,' and 'Soldier'", 1919, p. 8.
	Language = "cornish",
	Type = "noun",
	Meanings = {"Strife"}
})
