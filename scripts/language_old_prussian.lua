...
DefineLanguageWord("Caymis", { -- Source: August Fick and Alf Torp, "Wortschatz der Germanischen Spracheinheit", 2006, p. 53.
...
DefineLanguageWord("Seimíns", { -- Source: August Fick and Alf Torp, "Wortschatz der Germanischen Spracheinheit", 2006, p. 53.
	Language = "old-prussian", -- source gives Prussian
	Type = "noun",
