...
DefineTerrainFeature("east-anglia", {
	Name = "East Anglia",
	TerrainType = "dirt",
	Color = {64, 64, 0},
	World = "Earth"
...
DefineTerrainFeature("northumberland", {
	Name = "Northumberland",
	TerrainType = "dirt",
	Color = {96, 32, 0},
	World = "Earth"
...
DefineTerrainFeature("schleswig", {
	Name = "Schleswig",
	TerrainType = "dirt",
	Color = {96, 72, 0},
	World = "Earth"
