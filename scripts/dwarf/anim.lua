...
local AxefighterStill = {
	...
	"label set_variation", "random-goto 16 variation_1", "random-goto 20 variation_2", "random-goto 25 variation_3", "random-goto 33 variation_4", "random-goto 50 variation_5", "goto variation_6",
...
local AxefighterMove = {"unbreakable begin",
	...
	"frame 120", "move 3", "wait 2", "frame 125", "move 3", "wait 1",
	...
	"label variation_4", "set-var GraphicsVariation.Value = 4",
	"frame 180", "move 3", "wait 2", "frame 185", "move 3", "wait 1",
	...
	"label variation_5", "set-var GraphicsVariation.Value = 5",
	"frame 240", "move 3", "wait 2", "frame 245", "move 3", "wait 1",
	...
	"label variation_6", "set-var GraphicsVariation.Value = 6",
	"frame 300", "move 3", "wait 2", "frame 305", "move 3", "wait 1",
...
local SteelcladMove = {"unbreakable begin",
	...
	"if-var v.GraphicsVariation.Value == 6 variation_6", 
	"label set_variation", "random-goto 16 variation_1", "random-goto 20 variation_2", "random-goto 25 variation_3", "random-goto 33 variation_4", "random-goto 50 variation_5", "goto variation_6",
	"label variation_1", "set-var GraphicsVariation.Value = 1", "if-var v.PiercingDamage.Value >= 7 variation_1_great_axe",
	"frame 0", "move 3", "wait 2", "frame 5", "move 3", "wait 1",
	"frame 5", "move 3", "wait 2", "frame 10", "move 2", "wait 1",
	"frame 10", "move 3", "wait 1", "frame 0", "move 2", "wait 1",
	"frame 0", "move 3", "wait 2", "frame 15", "move 3", "wait 1",
	...
	"frame 75", "move 3", "wait 2", "frame 80", "move 2", "wait 1",
	"frame 80", "move 3", "wait 1", "frame 60", "move 2", "goto end",
	"label variation_2", "set-var GraphicsVariation.Value = 2", "if-var v.PiercingDamage.Value >= 7 variation_2_great_axe", 
	"frame 120", "move 3", "wait 2", "frame 125", "move 3", "wait 1",
	"frame 125", "move 3", "wait 2", "frame 130", "move 2", "wait 1",
	"frame 130", "move 3", "wait 1", "frame 120", "move 2", "wait 1",
	"frame 120", "move 3", "wait 2", "frame 135", "move 3", "wait 1",
	...
	"frame 195", "move 3", "wait 2", "frame 200", "move 2", "wait 1",
	"frame 200", "move 3", "wait 1", "frame 180", "move 2", "goto end",
	"label variation_3", "set-var GraphicsVariation.Value = 3", "if-var v.PiercingDamage.Value >= 7 variation_3_great_axe", 
	"frame 240", "move 3", "wait 2", "frame 245", "move 3", "wait 1",
	"frame 245", "move 3", "wait 2", "frame 250", "move 2", "wait 1",
	"frame 250", "move 3", "wait 1", "frame 240", "move 2", "wait 1",
	"frame 240", "move 3", "wait 2", "frame 255", "move 3", "wait 1",
	...
	"frame 315", "move 3", "wait 2", "frame 320", "move 2", "wait 1",
	"frame 320", "move 3", "wait 1", "frame 300", "move 2", "goto end",
	"label variation_4", "set-var GraphicsVariation.Value = 4", "if-var v.PiercingDamage.Value >= 7 variation_4_great_axe",
	"frame 360", "move 3", "wait 2", "frame 365", "move 3", "wait 1",
	...
	"label variation_4_great_axe",
	"frame 420", "move 3", "wait 2", "frame 425", "move 3", "wait 1",
	...
	"label variation_5", "set-var GraphicsVariation.Value = 5", "if-var v.PiercingDamage.Value >= 7 variation_5_great_axe", 
	"frame 480", "move 3", "wait 2", "frame 485", "move 3", "wait 1",
	...
	"label variation_5_great_axe",
	"frame 540", "move 3", "wait 2", "frame 545", "move 3", "wait 1",
	...
	"label variation_6", "set-var GraphicsVariation.Value = 6", "if-var v.PiercingDamage.Value >= 7 variation_6_great_axe", 
	"frame 600", "move 3", "wait 2", "frame 605", "move 3", "wait 1",
	...
	"label variation_6_great_axe",
	"frame 660", "move 3", "wait 2", "frame 665", "move 3", "wait 1",
