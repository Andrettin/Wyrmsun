...
DefineUnitType("unit-goblin-farm", { Name = "Farm",
	Class = "farm",
	Civilization = "goblin",
	Description = "Goblin farms provide sustenance for their settlements. Contrary to the dwarves, goblins tend to plant roots, rather than mushrooms, and they also breed livestock.",
