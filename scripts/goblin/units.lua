...
DefineUnitType("unit-goblin-spearman", { Name = _("Impaler"),
	...
	organic = true,
	SelectableByRectangle = true,
	CanCastSpell = {"spell-learn-critical-strike", "spell-unit-goblin-spearman", "spell-unit-goblin-archer", "spell-unit-goblin-war-machine"},
--	Mana = {Enable = true},
	Sounds = {
		"selected", "basic-goblin-voices-selected-group",
		"acknowledge", "basic-goblin-voices-acknowledge",
