...
-- Define Allows
function DefineAllowNormalGoblinUnits(flags)
	local units = {
	}
...
function DefineAllowExtraGoblinUnits(flags)
	local units = {
...
InitFuncs:add(function()
	DefineAllowNormalGoblinUnits("AAAAAAAAAAAAAAAA")
	DefineAllowExtraGoblinUnits("FFFFFFFFFFFFFFFF")
end)
