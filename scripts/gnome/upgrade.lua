...
--
--      upgrade.ccl - Define the gnomish dependencies and upgrades.
--
...
-- Define Allows
function DefineAllowNormalGnomishUnits(flags)
	local units = {
...
function DefineAllowExtraGnomishUnits(flags)
	local units = {
...
InitFuncs:add(function()
	DefineAllowNormalGnomishUnits("AAAAAAAAAAAAAAAA")
	DefineAllowExtraGnomishUnits("FFFFFFFFFFFFFFFF")
end)
