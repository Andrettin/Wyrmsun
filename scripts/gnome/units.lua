...
DefineUnitType("unit-gnomish-caravan", { Name = _("Caravan"),
	...
	MaxOnBoard = 2,
	CanTransport = {"GroundAttack", "false", "Fauna", "false", "LoseCargo", "false"}, -- forbidding ground attack as an ugly way of making ballistas not be able to enter the transporter; and forbidden "SaveCargo" is an ugly way of making caravans not be able to enter other caravans
