...
--		"wood-file-when-loaded", "gnome/units/gnomish_worker_with_lumber.png"
	}
	},
	Sounds = {
		"selected", "click",
...
DefineUnitType("unit-gnomish-farm", { Name = "Farm",
	Class = "farm",
	Civilization = "gnome",
	Description = "Gnomish farms provide sustenance for their settlements. Contrary to the dwarves, the gnomes tend to plant vegetables, rather than mushrooms.",
