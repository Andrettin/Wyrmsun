...
--
--      (c) Copyright 2013-2018 by Lutz Sammer, Jimmy Salmon and Andrettin
--
...
DefineIcon({
	Name = "icon-barkskin",
	Size = {46, 38},
	File = "neutral/icons/barkskin.png"
})
...
DefineIcon({
	Name = "icon-emerald-deposit",
	Size = {46, 38},
	File = "neutral/icons/emerald_deposit.png"
})

DefineIcon({
	Name = "icon-emerald-mine",
	Size = {46, 38},
	File = "neutral/icons/emerald_mine.png"
})
...
Load("scripts/civilizations/goth/icons.lua")
...
Load("scripts/civilizations/slav/icons.lua")
