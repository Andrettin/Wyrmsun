...
DefineWorld("Jotunheim", {
	Plane = "Material Plane",
	Description = _("Jotunheim is a brutal, hostile world. Jotunheim's sun is called Everbright, and its single moon is known as the Rapid Traveller. Lifeforms were originally brought to Jotunheim by primordial deities, a deed which left them exhausted for millions of years."),
