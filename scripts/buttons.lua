...
DefineButton( { Pos = 13, Level = 0, Icon = "icon-level-up",
	...
	ForUnit = {
		...
		"unit-teuton-swordsman", "unit-suebi-swordsman", "unit-frank-swordsman", "unit-teuton-veteran-swordsman",
		...
		"unit-forest-gnomish-recruit", "unit-forest-gnomish-duelist", "unit-forest-gnomish-master-at-arms", "unit-forest-gnomish-herbalist",
...
DefineButton( { Pos = 7, Level = 0, Icon = "icon-puncture",
	...
	ForUnit = {
		"unit-germanic-veteran-warrior", "unit-germanic-spearman",
		"unit-teuton-veteran-swordsman", "unit-teuton-spearman", "unit-frank-spearman",
		"unit-dwarven-guard",
		"unit-gnomish-master-at-arms", "unit-deep-gnomish-master-at-arms", "unit-forest-gnomish-master-at-arms", "unit-derro-shadowguard",
		"unit-goblin-thief", "unit-goblin-warlord", "unit-goblin-spearman",
		"unit-elven-swordsman"
