...
Load("scripts/settlements_china.lua")
Load("scripts/settlements_crimea.lua")
...
Load("scripts/settlements_finland.lua")
...
Load("scripts/settlements_netherlands.lua")
Load("scripts/settlements_niflheim.lua")
Load("scripts/settlements_north_africa.lua")
Load("scripts/settlements_norway.lua")
