...
DefineLanguage("high-german", { -- define High German early to prevent some type name generation weirdnesses
	...
	AdjectiveEndings = {
		...
		"no-article", "nominative", "plural", "none", "e",
		...
		"indefinite", "nominative", "plural", "none", "en",
		...
		"indefinite", "accusative", "plural", "none", "en",
		"indefinite", "dative", "no-number", "none", "en",
		"indefinite", "genitive", "no-number", "none", "en"
	},
	NameTranslations = {
