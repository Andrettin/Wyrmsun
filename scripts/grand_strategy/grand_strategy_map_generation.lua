	...
	for province_key, province_value in pairs(WorldMapProvinces) do
		if (GetProvinceOwner(WorldMapProvinces[province_key].Name) ~= "asa-tribe" and GetProvinceOwner(WorldMapProvinces[province_key].Name) ~= "brising-clan") then
			for key, value in pairs(Factions) do
				if (Factions[key].Civilization == "basque" or Factions[key].Civilization == "celt" or Factions[key].Civilization == "dwarf" or Factions[key].Civilization == "egyptian" or Factions[key].Civilization == "etruscan" or Factions[key].Civilization == "germanic" or Factions[key].Civilization == "gnome" or Factions[key].Civilization == "goblin" or Factions[key].Civilization == "greek" or Factions[key].Civilization == "hittite" or Factions[key].Civilization == "illyrian" or Factions[key].Civilization == "kobold" or Factions[key].Civilization == "latin" or Factions[key].Civilization == "minotaur" or Factions[key].Civilization == "minoan" or Factions[key].Civilization == "persian" or Factions[key].Civilization == "phoenician" or Factions[key].Civilization == "phrygian" or Factions[key].Civilization == "slav" or Factions[key].Civilization == "thracian" or Factions[key].Civilization == "uralic" or Factions[key].Civilization == "etruscan") then
