			...
			function(s)
				...
				for i, unitName in ipairs(Units) do -- migrate the Vana workers
					if (string.find(unitName, "upgrade-") == nil and GetUnitTypeData(unitName, "Class") == "worker") then
						ChangeProvinceUnitQuantity("Albania", unitName, GetProvinceUnitQuantity("Don", unitName) / 13)
						ChangeProvinceUnitQuantity("Aquitaine", unitName, GetProvinceUnitQuantity("Don", unitName) / 13)
						ChangeProvinceUnitQuantity("Argolis", unitName, GetProvinceUnitQuantity("Don", unitName) / 13)
						ChangeProvinceUnitQuantity("Austria", unitName, GetProvinceUnitQuantity("Don", unitName) / 13)
						ChangeProvinceUnitQuantity("Belgium", unitName, GetProvinceUnitQuantity("Don", unitName) / 13)
						ChangeProvinceUnitQuantity("Bohemia", unitName, GetProvinceUnitQuantity("Don", unitName) / 13)
						ChangeProvinceUnitQuantity("Bulgaria", unitName, GetProvinceUnitQuantity("Don", unitName) / 13)
						ChangeProvinceUnitQuantity("Burgundy", unitName, GetProvinceUnitQuantity("Don", unitName) / 13)
						ChangeProvinceUnitQuantity("Dalmatia", unitName, GetProvinceUnitQuantity("Don", unitName) / 13)
						ChangeProvinceUnitQuantity("Epirus", unitName, GetProvinceUnitQuantity("Don", unitName) / 13)
						ChangeProvinceUnitQuantity("Franche Comte", unitName, GetProvinceUnitQuantity("Don", unitName) / 13)
						ChangeProvinceUnitQuantity("Latium", unitName, GetProvinceUnitQuantity("Don", unitName) / 13)
						ChangeProvinceUnitQuantity("Switzerland", unitName, GetProvinceUnitQuantity("Don", unitName) / 13)
