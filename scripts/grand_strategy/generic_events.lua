...
DefineGrandStrategyEvent("Build Library?", {
	...
	Conditions = function(s)
		if (
			...
			and GetFactionResource(EventFaction.Civilization, EventFaction.Name, "copper") >= 800
	...
	OptionEffects = {
		function(s)
			ChangeFactionResource(EventFaction.Civilization, EventFaction.Name, "copper", -800)
...
DefineGrandStrategyEvent("Build College?", {
	...
	Conditions = function(s)
		if (
			SyncRand(100) < math.min(5, math.floor(GetFactionResource(EventFaction.Civilization, EventFaction.Name, "prestige") / 20)) -- 5% chance the event happens at all if prestige is at least 100, and then 10% chance that it happens to a particular province, for a total chance of 0.1% of happening if the player has one province
			and GetFactionResource(EventFaction.Civilization, EventFaction.Name, "copper") >= 900
	...
	OptionEffects = {
		function(s)
			ChangeFactionResource(EventFaction.Civilization, EventFaction.Name, "copper", -900)
...
DefineGrandStrategyEvent("Build University?", {
	...
	Conditions = function(s)
		if (
			SyncRand(100) < math.min(5, math.floor(GetFactionResource(EventFaction.Civilization, EventFaction.Name, "prestige") / 20)) -- 5% chance the event happens at all if prestige is at least 100, and then 10% chance that it happens to a particular province, for a total chance of 0.1% of happening if the player has one province
			and GetFactionResource(EventFaction.Civilization, EventFaction.Name, "copper") >= 1500
	...
	OptionEffects = {
		function(s)
			ChangeFactionResource(EventFaction.Civilization, EventFaction.Name, "copper", -1500)
