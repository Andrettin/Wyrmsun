	...
	LiafwinFoundsOratory = { -- Source: B. H. Slicher van Bath, "Dutch Tribal Problems", 1949, p. 320.
		...
		Conditions = function(s)
			if (
				...
				and GetProvinceCivilization("Essex") == "anglo_saxon" -- Liafwin's province of origin has to be the same culture as he historically was; Essex set because he was from England and this is the province where London lays
			) then
