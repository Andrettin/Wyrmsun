...
Regions = {
	...
	GermanyNetherlands = {"Augsburg", "Austria", "Baden", "Bavaria", "Belgium", "Brandenburg", "Bremen", "Brunswick", "East Friesland", "Franconia", "Friesland", "Hanover", "Holland", "Holstein", "Mecklenburg", "Oldenburg", "Rhineland", "Silesia", "Wurtemberg"},
