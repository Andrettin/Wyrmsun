...
Regions = {
	...
	NorthwestEurope = {"Alsace", "Aquitaine", "Belgium", "Brittany", "Burgundy", "Cumbria", "Drenthe", "Durham", "England", "France", "Franche Comte", "Friesland", "Highland Scotland", "Holland", "Ireland", "Lorraine", "Lowland Scotland", "Mercia", "Moselle", "Normandy", "Northumberland", "Orkney", "Overijssel", "Provence", "Savoy", "Wales", "York"},
