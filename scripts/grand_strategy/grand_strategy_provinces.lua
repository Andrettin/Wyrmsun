...
Regions = {
	BritishIsles = {"Durham", "England", "Highland Scotland", "Ireland", "Lowland Scotland", "Northumberland", "Orkney"},
	Czechoslovakia = {"Bohemia", "Moravia", "Slovakia"},
	England = {"Durham", "England", "Northumberland"},
	...
	NorthwestEurope = {"Alsace", "Aquitaine", "Belgium", "Brittany", "Burgundy", "Drenthe", "Durham", "England", "France", "Franche Comte", "Friesland", "Highland Scotland", "Holland", "Ireland", "Lorraine", "Lowland Scotland", "Moselle", "Normandy", "Northumberland", "Orkney", "Overijssel", "Provence", "Savoy"},
