...
Regions = {
	...
	GermanyNetherlands = {"Augsburg", "Austria", "Baden", "Bavaria", "Belgium", "Brandenburg", "Bremen", "Brunswick", "East Friesland", "Franconia", "Friesland", "Hanover", "Holland", "Holstein", "Oldenburg", "Rhineland", "Silesia", "Wurtemberg"},
