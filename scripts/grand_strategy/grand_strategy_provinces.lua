...
Regions = {
	...
	NorthwestEurope = {"Alsace", "Aquitaine", "Belgium", "Brittany", "Burgundy", "Cornwall", "Cumbria", "Drenthe", "Durham", "East Anglia", "Essex", "France", "Franche Comte", "Friesland", "Highland Scotland", "Holland", "Ireland", "Kent", "Lincoln", "Lorraine", "Lowland Scotland", "Mercia", "Moselle", "Normandy", "Northumberland", "Orkney", "Overijssel", "Provence", "Savoy", "Sussex", "Wales", "Wessex", "York"},
