...
DefineCharacter("thjodrorir", { -- dwarf from Norse mythology; Source: Kevin Crossley-Holland, "The Norse Myths", 1980, p. 17; Source: Henry Adams Bellows (transl.), "The Poetic Edda", 1936, p. 66.
	...
	Background = "In Norse mythology, Thjodrorir was a dwarf who knew a potent magic charm. This he sang before the doors of the god Delling, to bring might for the gods, glory for the elves and wisdom for Odin. Thjodrorir is mentioned in the <a href='literary_text:hovamol'>Hovamol</a>.",
...
DefineCharacter("alvis", { -- Source: Kevin Crossley-Holland, "The Norse Myths", 1980, pp. 144-145; Source: Henry Adams Bellows (transl.), "The Poetic Edda", 1936, pp. 183-194.
	...
	Type = "unit-dwarven-loremaster",
	Civilization = "dwarf",
	Background = "In the <a href='literary_text:alvissmol'>Alvissmol</a>, Alvis is an extremely knowledgeable dwarf who desires to marry Thor's daughter. His name means \"all-knowing\" or \"all-wise\".",
	HairVariation = "gray-hair",
	Trait = "upgrade-wise",
	Deities = {"odin", "tyr"}
})
