...
DefineQuest("andvaris-gold", {
	...
	AcceptEffects = function(s)
		...
		unit = CreateUnit("unit-revealer", trigger_player, {CPlayer:GetPlayer(oinling_player).StartPos.x, CPlayer:GetPlayer(oinling_player).StartPos.y}, GetMapLayer("nidavellir")) -- show the location of Andvari's holding
		SetUnitVariable(unit, "TTL", 600)
	end,
	CompletionEffects = function(s)
		local oinling_player = GetFactionPlayer("oinling-clan")
		SetPlayerData(trigger_player, "Resources", "copper", GetPlayerData(trigger_player, "Resources", "copper") + 10000)
		unit = CreateUnit("unit-ring", PlayerNumNeutral, {CPlayer:GetPlayer(oinling_player).StartPos.x, CPlayer:GetPlayer(oinling_player).StartPos.y}, GetSiteData("andvaris-falls", "MapLayer"))
		...
		unit = CreateUnit("unit-revealer", trigger_player, {CPlayer:GetPlayer(oinling_player).StartPos.x, CPlayer:GetPlayer(oinling_player).StartPos.y}, GetMapLayer("nidavellir")) -- show the location of the ring
		SetUnitVariable(unit, "TTL", 600)
