	...
	function()
		...
		if (
			(
				...
				or PlayerHasObjective(GetFactionPlayer("Norlund Clan"), "- Mine 10000 metal and 20000 coal") 
							...
							Event(
								...
								Event(
									...
									if (GrandStrategy) then
										...
										ChangeFactionResource("gnome", "untersberg", "metal", -7500)
