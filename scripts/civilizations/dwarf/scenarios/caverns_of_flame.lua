...
if (LoadedGame == false) then
	...
	unit = CreateUnit("unit-goblin-spearman", 2, {CPlayer:GetPlayer(2).StartPos.x, CPlayer:GetPlayer(2).StartPos.y})
	...
	unit = CreateUnit("unit-goblin-spearman", 2, {CPlayer:GetPlayer(2).StartPos.x, CPlayer:GetPlayer(2).StartPos.y})
	SetUnitVariable(unit, "Active", false)
	unit = CreateUnit("unit-goblin-archer", 2, {CPlayer:GetPlayer(2).StartPos.x, CPlayer:GetPlayer(2).StartPos.y})
	SetUnitVariable(unit, "Active", false)
	unit = CreateUnit("unit-goblin-archer", 2, {CPlayer:GetPlayer(2).StartPos.x, CPlayer:GetPlayer(2).StartPos.y})
	SetUnitVariable(unit, "Active", false)
	unit = CreateUnit("unit-goblin-archer", 2, {CPlayer:GetPlayer(2).StartPos.x, CPlayer:GetPlayer(2).StartPos.y})
	...
	unit = CreateUnit("unit-goblin-spearman", 3, {CPlayer:GetPlayer(3).StartPos.x, CPlayer:GetPlayer(3).StartPos.y})
	SetUnitVariable(unit, "Active", false)
	unit = CreateUnit("unit-goblin-spearman", 3, {CPlayer:GetPlayer(3).StartPos.x, CPlayer:GetPlayer(3).StartPos.y})
	SetUnitVariable(unit, "Active", false)
	unit = CreateUnit("unit-goblin-spearman", 3, {CPlayer:GetPlayer(3).StartPos.x, CPlayer:GetPlayer(3).StartPos.y})
	...
	unit = CreateUnit("unit-goblin-spearman", 3, {CPlayer:GetPlayer(3).StartPos.x, CPlayer:GetPlayer(3).StartPos.y})
	SetUnitVariable(unit, "Active", false)
	unit = CreateUnit("unit-goblin-archer", 3, {CPlayer:GetPlayer(3).StartPos.x, CPlayer:GetPlayer(3).StartPos.y})
	SetUnitVariable(unit, "Active", false)
	unit = CreateUnit("unit-goblin-archer", 3, {CPlayer:GetPlayer(3).StartPos.x, CPlayer:GetPlayer(3).StartPos.y})
	SetUnitVariable(unit, "Active", false)
	unit = CreateUnit("unit-goblin-archer", 3, {CPlayer:GetPlayer(3).StartPos.x, CPlayer:GetPlayer(3).StartPos.y})
...
AddTrigger("caverns-of-flame-rugnurs-dwarves-move-to-glyph",
	...
	function() 
		...
		for unit1 = 1,table.getn(uncount) do 
			if (GetUnitVariable(uncount[unit1], "Idle")) then
				OrderUnit(GetFactionPlayer("Norlund Clan"), GetUnitVariable(uncount[unit1],"Ident"), {GetUnitVariable(uncount[unit1],"PosX"), GetUnitVariable(uncount[unit1],"PosY")}, 0, {GetUnitVariable(glyph,"PosX"), GetUnitVariable(glyph,"PosY")}, 0, "move")
			end
		end
...
AddTrigger("caverns-of-flame-shinsplitters-eruption-death",
	...
	function()
		...
		Event(
			...
			{"~!Continue"},
			{function(s)
				KillUnitAt("unit-dwarven-axefighter", GetFactionPlayer("Shinsplitter Clan"), GetPlayerData(GetFactionPlayer("Shinsplitter Clan"), "UnitTypesCount", "unit-dwarven-axefighter"), {0, 0}, {MaxMapWidth, MaxMapHeight})
				KillUnitAt("unit-dwarven-steelclad", GetFactionPlayer("Shinsplitter Clan"), GetPlayerData(GetFactionPlayer("Shinsplitter Clan"), "UnitTypesCount", "unit-dwarven-steelclad"), {0, 0}, {MaxMapWidth, MaxMapHeight})
				KillUnitAt("unit-dwarven-thane", GetFactionPlayer("Shinsplitter Clan"), GetPlayerData(GetFactionPlayer("Shinsplitter Clan"), "UnitTypesCount", "unit-dwarven-thane"), {0, 0}, {MaxMapWidth, MaxMapHeight})
				KillUnitAt("unit-dwarven-scout", GetFactionPlayer("Shinsplitter Clan"), GetPlayerData(GetFactionPlayer("Shinsplitter Clan"), "UnitTypesCount", "unit-dwarven-scout"), {0, 0}, {MaxMapWidth, MaxMapHeight})
				KillUnitAt("unit-dwarven-pathfinder", GetFactionPlayer("Shinsplitter Clan"), GetPlayerData(GetFactionPlayer("Shinsplitter Clan"), "UnitTypesCount", "unit-dwarven-pathfinder"), {0, 0}, {MaxMapWidth, MaxMapHeight})
				KillUnitAt("unit-dwarven-explorer", GetFactionPlayer("Shinsplitter Clan"), GetPlayerData(GetFactionPlayer("Shinsplitter Clan"), "UnitTypesCount", "unit-dwarven-explorer"), {0, 0}, {MaxMapWidth, MaxMapHeight})
				KillUnitAt("unit-dwarven-yale-rider", GetFactionPlayer("Shinsplitter Clan"), GetPlayerData(GetFactionPlayer("Shinsplitter Clan"), "UnitTypesCount", "unit-dwarven-yale-rider"), {0, 0}, {MaxMapWidth, MaxMapHeight})
				KillUnitAt("unit-dwarven-yale-lord", GetFactionPlayer("Shinsplitter Clan"), GetPlayerData(GetFactionPlayer("Shinsplitter Clan"), "UnitTypesCount", "unit-dwarven-yale-lord"), {0, 0}, {MaxMapWidth, MaxMapHeight})
				KillUnitAt("unit-dwarven-ballista", GetFactionPlayer("Shinsplitter Clan"), GetPlayerData(GetFactionPlayer("Shinsplitter Clan"), "UnitTypesCount", "unit-dwarven-ballista"), {0, 0}, {MaxMapWidth, MaxMapHeight})
				KillUnitAt("unit-surghan-mercenary-steelclad", GetFactionPlayer("Shinsplitter Clan"), GetPlayerData(GetFactionPlayer("Shinsplitter Clan"), "UnitTypesCount", "unit-surghan-mercenary-steelclad"), {0, 0}, {MaxMapWidth, MaxMapHeight})
				KillUnitAt("unit-surghan-mercenary-thane", GetFactionPlayer("Shinsplitter Clan"), GetPlayerData(GetFactionPlayer("Shinsplitter Clan"), "UnitTypesCount", "unit-surghan-mercenary-thane"), {0, 0}, {MaxMapWidth, MaxMapHeight})
			end}
		)
		return false
	end
...
AddTrigger("caverns-of-flame-ending",
	...
	function()
		Event(
			...
			{"~!Continue"},
			{function(s)
			KillUnitAt("unit-dwarven-axefighter", GetFactionPlayer("Norlund Clan"), GetPlayerData(GetFactionPlayer("Norlund Clan"), "UnitTypesCount", "unit-dwarven-axefighter"), {0, 0}, {MaxMapWidth, MaxMapHeight})
			KillUnitAt("unit-dwarven-steelclad", GetFactionPlayer("Norlund Clan"), GetPlayerData(GetFactionPlayer("Norlund Clan"), "UnitTypesCount", "unit-dwarven-steelclad"), {0, 0}, {MaxMapWidth, MaxMapHeight})
			KillUnitAt("unit-dwarven-thane", GetFactionPlayer("Norlund Clan"), GetPlayerData(GetFactionPlayer("Norlund Clan"), "UnitTypesCount", "unit-dwarven-thane"), {0, 0}, {MaxMapWidth, MaxMapHeight})
			KillUnitAt("unit-dwarven-runemaster", GetFactionPlayer("Norlund Clan"), GetPlayerData(GetFactionPlayer("Norlund Clan"), "UnitTypesCount", "unit-dwarven-runemaster"), {0, 0}, {MaxMapWidth, MaxMapHeight})
			KillUnitAt("unit-dwarven-arcanister", GetFactionPlayer("Norlund Clan"), GetPlayerData(GetFactionPlayer("Norlund Clan"), "UnitTypesCount", "unit-dwarven-arcanister"), {0, 0}, {MaxMapWidth, MaxMapHeight})
			KillUnitAt("unit-dwarven-scout", GetFactionPlayer("Norlund Clan"), GetPlayerData(GetFactionPlayer("Norlund Clan"), "UnitTypesCount", "unit-dwarven-scout"), {0, 0}, {MaxMapWidth, MaxMapHeight})
			KillUnitAt("unit-dwarven-pathfinder", GetFactionPlayer("Norlund Clan"), GetPlayerData(GetFactionPlayer("Norlund Clan"), "UnitTypesCount", "unit-dwarven-pathfinder"), {0, 0}, {MaxMapWidth, MaxMapHeight})
			KillUnitAt("unit-dwarven-explorer", GetFactionPlayer("Norlund Clan"), GetPlayerData(GetFactionPlayer("Norlund Clan"), "UnitTypesCount", "unit-dwarven-explorer"), {0, 0}, {MaxMapWidth, MaxMapHeight})
			KillUnitAt("unit-dwarven-yale-rider", GetFactionPlayer("Norlund Clan"), GetPlayerData(GetFactionPlayer("Norlund Clan"), "UnitTypesCount", "unit-dwarven-yale-rider"), {0, 0}, {MaxMapWidth, MaxMapHeight})
			KillUnitAt("unit-dwarven-yale-lord", GetFactionPlayer("Norlund Clan"), GetPlayerData(GetFactionPlayer("Norlund Clan"), "UnitTypesCount", "unit-dwarven-yale-lord"), {0, 0}, {MaxMapWidth, MaxMapHeight})
			KillUnitAt("unit-dwarven-ballista", GetFactionPlayer("Norlund Clan"), GetPlayerData(GetFactionPlayer("Norlund Clan"), "UnitTypesCount", "unit-dwarven-ballista"), {0, 0}, {MaxMapWidth, MaxMapHeight})
