	...
	function()
		...
		Event(
			...
			if (GrandStrategy == false) then
				...
				unit = CreateUnit("unit-dwarven-pathfinder", GetFactionPlayer("Shinsplitter Clan"), {Players[GetFactionPlayer("Shinsplitter Clan")].StartPos.x, Players[GetFactionPlayer("Shinsplitter Clan")].StartPos.y + 7})
