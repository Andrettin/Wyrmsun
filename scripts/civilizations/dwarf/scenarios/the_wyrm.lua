			...
			Event(
				...
				{function(s)
					if (GrandStrategy) then
						KillUnitAt("unit-dwarven-guard-tower", GetFactionPlayer("Norlund Clan"), GetPlayerData(GetFactionPlayer("Norlund Clan"), "UnitTypesCount", "unit-dwarven-guard-tower"), {0, 0}, {MaxMapWidth, MaxMapHeight})
