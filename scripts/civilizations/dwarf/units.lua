...
--		{"shield", "unit-round-shield"}, -- commented out to make the Brising Round Shield icon appear when proper
	...
	Costs = {"time", 60, "metal", 500, "lumber", 45},
	Corpse = "unit-dwarven-dead-body",
...
--		{"shield", "unit-round-shield"}, -- commented out to make the Brising Round Shield icon appear when proper
	...
	Costs = {"time", 90, "metal", 825, "lumber", 75},
	Armor = 4,
	Corpse = "unit-dwarven-dead-body",
	WeaponClasses = {"axe", "mace"},
	HackDamage = true,
...
--		{"shield", "unit-round-shield"}, -- commented out to make the Brising Round Shield icon appear when proper
	...
	Costs = {"time", 55, "metal", 460, "lumber", 90},
	HitPoints = 65,
	Armor = 2,
	Corpse = "unit-dwarven-dead-body",
	PierceDamage = true,
...
DefineUnitType("unit-dwarven-town-hall", { Name = _("Mead Hall"),
	...
	Costs = {"time", 255, "metal", 1200, "lumber", 1800, "stone", 600},
...
DefineUnitType("unit-dwarven-stronghold", { Name = _("Bastion"),
	...
	Costs = {"time", 200, "metal", 2000, "lumber", 1400, "stone", 2200},
	RepairCosts = {"metal", 1, "lumber", 1, "stone", 1},
	FireResistance = 20,
...
DefineUnitType("unit-dwarven-mushroom-farm", { Name = _("Mushroom Farm"),
	...
	Costs = {"time", 100, "metal", 500, "lumber", 500, "stone", 250},
	RepairCosts = {"metal", 1, "lumber", 1, "stone", 1},
	FireResistance = 20,
...
DefineUnitType("unit-dwarven-barracks", { Name = _("War Hall"),
	...
	Costs = {"time", 200, "metal", 700, "lumber", 900, "stone", 450},
	RepairCosts = {"metal", 1, "lumber", 1, "stone", 1},
	FireResistance = 20,
	ButtonKey = "w",
...
--	Costs = {"time", 165, "metal", 660, "lumber", 1485},
	Costs = {"time", 165, "metal", 660, "lumber", 990, "stone", 495},
	RepairCosts = {"metal", 1, "lumber", 1, "stone", 1},
	FireResistance = 20,
	TechnologyPointCost = 1,
	Drops = {"unit-stone-pile"},
...
--	Costs = {"time", 190, "metal", 800, "lumber", 1560},
	Costs = {"time", 190, "metal", 800, "lumber", 1040, "stone", 520},
	RepairCosts = {"metal", 1, "lumber", 1, "stone", 1},
	FireResistance = 20,
	TechnologyPointCost = 1,
	Drops = {"unit-stone-pile"},
...
--	Costs = {"time", 150, "metal", 1000, "lumber", 900},
	Costs = {"time", 150, "metal", 1000, "lumber", 600, "stone", 300},
	RepairCosts = {"metal", 1, "lumber", 1, "stone", 1},
	FireResistance = 20,
	TechnologyPointCost = 1,
	ButtonKey = "y",
...
--	Costs = {"time", 175, "metal", 900, "lumber", 1500},
	Costs = {"time", 175, "metal", 900, "lumber", 1000, "stone", 500},
	RepairCosts = {"metal", 1, "lumber", 1, "stone", 1},
	FireResistance = 20,
...
DefineUnitType("unit-dwarven-sentry-tower", { Name = _("Sentry Tower"),
	...
	Costs = {"time", 60, "metal", 550, "lumber", 200, "stone", 400},
	RepairCosts = {"metal", 1, "lumber", 1, "stone", 1},
	FireResistance = 20,
...
DefineUnitType("unit-dwarven-guard-tower", { Name = _("Guard Tower"),
	...
	Costs = {"time", 140, "metal", 500, "lumber", 150, "stone", 300},
	RepairCosts = {"metal", 1, "lumber", 1, "stone", 1},
	FireResistance = 20,
...
--	Costs = {"time", 200, "metal", 800, "lumber", 1350},
	Costs = {"time", 200, "metal", 800, "lumber", 900, "stone", 450},
	RepairCosts = {"metal", 1, "lumber", 1, "stone", 1},
	FireResistance = 20,
...
DefineUnitType("unit-surghan-mercenary-steelclad", { Name = _("Surghan Mercenary"),
	...
	Costs = {"time", 0, "metal", 900, "lumber", 0},
	TrainQuantity = 4,
	Mercenary = true,
	ButtonPos = 5,
	ButtonKey = "s",
