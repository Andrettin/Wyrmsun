...
DefineUnitType("unit-dwarven-thane", { Name = _("Stonelord"),
	...
	Civilization = "dwarf",
	Description = _("Clad in shining armor, these dwarves look like kings from under the mountains. They wield the axe with masterful skill, and though slow on their feet, these dwarves are a testament to the prowess of their kin."),
