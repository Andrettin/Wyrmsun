...
DefineUnitType("unit-dwarven-town-hall", { Name = _("Mead Hall"),
	...
	Costs = {"time", 255, "copper", 1200, "lumber", 1800, "stone", 600},
...
DefineUnitType("unit-dwarven-stronghold", { Name = _("Bastion"),
	...
	Costs = {"time", 200, "copper", 2000, "lumber", 1400, "stone", 2200},
	RepairCosts = {"copper", 1, "lumber", 1, "stone", 1},
	FireResistance = 20,
...
DefineUnitType("unit-dwarven-mushroom-farm", { Name = _("Mushroom Farm"),
	...
	Costs = {"time", 100, "copper", 500, "lumber", 500, "stone", 250},
	RepairCosts = {"copper", 1, "lumber", 1, "stone", 1},
	FireResistance = 20,
...
DefineUnitType("unit-dwarven-barracks", { Name = _("War Hall"),
	...
	Costs = {"time", 200, "copper", 700, "lumber", 900, "stone", 450},
	RepairCosts = {"copper", 1, "lumber", 1, "stone", 1},
	FireResistance = 20,
	ButtonKey = "w",
...
--	Costs = {"time", 165, "copper", 660, "lumber", 1485},
	Costs = {"time", 165, "copper", 660, "lumber", 990, "stone", 495},
	RepairCosts = {"copper", 1, "lumber", 1, "stone", 1},
	FireResistance = 20,
	TechnologyPointCost = 1,
	Drops = {"unit-stone-pile"},
...
--	Costs = {"time", 190, "copper", 800, "lumber", 1560},
	Costs = {"time", 190, "copper", 800, "lumber", 1040, "stone", 520},
	RepairCosts = {"copper", 1, "lumber", 1, "stone", 1},
	FireResistance = 20,
	TechnologyPointCost = 1,
	Drops = {"unit-stone-pile"},
...
--	Costs = {"time", 150, "copper", 1000, "lumber", 900},
	Costs = {"time", 150, "copper", 1000, "lumber", 600, "stone", 300},
	RepairCosts = {"copper", 1, "lumber", 1, "stone", 1},
	FireResistance = 20,
	TechnologyPointCost = 1,
	ButtonKey = "y",
...
--	Costs = {"time", 175, "copper", 900, "lumber", 1500},
	Costs = {"time", 175, "copper", 900, "lumber", 1000, "stone", 500},
	RepairCosts = {"copper", 1, "lumber", 1, "stone", 1},
	FireResistance = 20,
...
DefineUnitType("unit-dwarven-sentry-tower", { Name = _("Sentry Tower"),
	...
	Costs = {"time", 60, "copper", 550, "lumber", 200, "stone", 400},
	RepairCosts = {"copper", 1, "lumber", 1, "stone", 1},
	FireResistance = 20,
...
DefineUnitType("unit-dwarven-guard-tower", { Name = _("Guard Tower"),
	...
	Costs = {"time", 140, "copper", 500, "lumber", 150, "stone", 300},
	RepairCosts = {"copper", 1, "lumber", 1, "stone", 1},
	FireResistance = 20,
