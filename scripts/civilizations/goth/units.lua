...
DefineUnitType("unit-gothic-horse-rider", {
	...
	ButtonKey = "d",
	AiDrops = {"unit-short-sword", "unit-broad-sword", "unit-spatha", "unit-wooden-shield", "unit-bronze-shield", "unit-iron-shield", "unit-kite-shield", "unit_knightly_helmet", "unit-boots", "unit-cheese", "unit-carrots", "unit_meat", "unit_meat", "unit-potion-of-healing"},
