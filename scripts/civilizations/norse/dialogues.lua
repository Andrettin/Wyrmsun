...
DefineDialogue("the-house-of-seven-fathers", { -- based on the "The Seventh Father of the House" Norwegian folktale; Source: Peter Christen Asbjørnsen and Jørgen Moe, "Norwegian Folktales", 1960, pp. 13-14.
	Nodes = {
		...
		{
			"text", "TRIGGER_HERO enters the kitchen, and sees a man older than the first by the fireside. TRIGGER_HERO_PERSONAL_PRONOUN_CAPITALIZED inquires whether TRIGGER_HERO_PERSONAL_PRONOUN can spend the night. The old man answers that he is not the father of the house either, and that the traveller should ask his father, who is in the parlor."
		},
		{
