...
DefineDialogue("jarl-fails-to-ally-with-the-hersings", {
	Nodes = {
		...
		},
		{
			...
			"option-effects", {
				function(s)
					unit = CreateUnit("unit-revealer", GetFactionPlayer("hersing-tribe"), {GetPlayerData(trigger_player, "StartPosX"), GetPlayerData(trigger_player, "StartPosY")}, CPlayer:GetPlayer(trigger_player).StartMapLayer)
