...
--	WeaponClasses = {"mace"},
	...
	StartingAbilities = {"upgrade-inspire", "upgrade-precision", "upgrade-shocking-grasp", "upgrade-wither"},
	CanCastSpell = {"spell-inspire", "spell-healing", "spell-precision", "spell-shocking-grasp", "spell-wither"},
