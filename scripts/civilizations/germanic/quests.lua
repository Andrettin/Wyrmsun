...
DefineQuest("slay-the-berserker-brides-at-hlesey", { -- Source: Kevin Crossley-Holland, "The Norse Myths", 1980, p. 119.
	...
	Conditions = function(s)
		if (
			...
			and GetNumUnitsAt(trigger_player, "buildings", {4089 - 128 - EarthStartX, 745 - 128 - EarthStartY}, {4089 + 128 - EarthStartX, 745 + 128 - EarthStartY}, GetMapLayer("material-plane", "earth")) > 0 -- the player must have a building relatively close to Hlesey
		) then
			return true
		end
		return false
