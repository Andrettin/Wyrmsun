...
if (LoadedGame == false) then
	...
	--	unit = CreateUnit("unit-suebi-swordsman", 0, {CPlayer:GetPlayer(0).StartPos.x, CPlayer:GetPlayer(0).StartPos.y}) -- add Ballomar here later
		...
		unit = CreateUnit("unit-latin-legionary", rome_player, {CPlayer:GetPlayer(rome_player).StartPos.x, CPlayer:GetPlayer(rome_player).StartPos.y})
		...
		unit = CreateUnit("unit-latin-legionary", rome_player, {CPlayer:GetPlayer(rome_player).StartPos.x, CPlayer:GetPlayer(rome_player).StartPos.y})
		SetUnitVariable(unit, "Active", false)
		unit = CreateUnit("unit-latin-javelineer", rome_player, {CPlayer:GetPlayer(rome_player).StartPos.x, CPlayer:GetPlayer(rome_player).StartPos.y})
		SetUnitVariable(unit, "Active", false)
		unit = CreateUnit("unit-latin-javelineer", rome_player, {CPlayer:GetPlayer(rome_player).StartPos.x, CPlayer:GetPlayer(rome_player).StartPos.y})
		SetUnitVariable(unit, "Active", false)
		unit = CreateUnit("unit-latin-javelineer", rome_player, {CPlayer:GetPlayer(rome_player).StartPos.x, CPlayer:GetPlayer(rome_player).StartPos.y})
		...
		unit = CreateUnit("unit-suebi-swordsman", 4, {CPlayer:GetPlayer(4).StartPos.x, CPlayer:GetPlayer(4).StartPos.y})
		unit = CreateUnit("unit-suebi-swordsman", 4, {CPlayer:GetPlayer(4).StartPos.x, CPlayer:GetPlayer(4).StartPos.y})
		unit = CreateUnit("unit-suebi-swordsman", 4, {CPlayer:GetPlayer(4).StartPos.x, CPlayer:GetPlayer(4).StartPos.y})
		unit = CreateUnit("unit-suebi-swordsman", 4, {CPlayer:GetPlayer(4).StartPos.x, CPlayer:GetPlayer(4).StartPos.y})
		unit = CreateUnit("unit-suebi-swordsman", 4, {CPlayer:GetPlayer(4).StartPos.x, CPlayer:GetPlayer(4).StartPos.y})
