...
--	Background = "The appearance of the Rathaus is based on the Tallinn Town Hall, which was originally built by Hanseatic merchants.",
	...
	Variations = {
		...
		{
			"variation-id", "town-hall-snow-winter",
			"file", "teuton/buildings/town_hall_snow.png",
			"upgrade-required", "upgrade-masonry",
			"terrain", "dirt",
			"terrain", "dry-mud",
			"terrain", "grass",
...
--	Name = "Burg",
	...
	Variations = {
		...
		},
		{
			...
			"file", "teuton/buildings/stronghold_snow.png",
			"terrain", "dirt",
			"terrain", "dry-mud",
			"terrain", "grass",
			"terrain", "snow",
...
DefineUnitType("unit-teuton-farm", {
	...
	Variations = {
		...
		{
			"variation-id", "farm-snow-winter",
			"file", "teuton/buildings/farm_snow.png",
			"upgrade-required", "upgrade-masonry",
			"terrain", "dirt",
			"terrain", "dry-mud",
			"terrain", "grass",
...
DefineUnitType("unit-teuton-barracks", {
	...
	Variations = {
		...
		{
			"variation-id", "barracks-snow-winter",
			"file", "teuton/buildings/barracks_snow.png",
			"upgrade-required", "upgrade-masonry",
			"terrain", "dirt",
			"terrain", "dry-mud",
			"terrain", "grass",
...
DefineUnitType("unit-teuton-smithy", {
	...
	Variations = {
		...
		{
			"variation-id", "smithy-snow-winter",
			"file", "teuton/buildings/smithy_snow.png",
			"upgrade-required", "upgrade-masonry",
			"terrain", "dirt",
			"terrain", "dry-mud",
			"terrain", "grass",
...
DefineUnitType("unit-teuton-masons-shop", {
	...
	Variations = {
		...
		{
			"variation-id", "masons-shop-snow-winter",
			"file", "teuton/buildings/masons_shop_snow.png",
			"upgrade-required", "upgrade-masonry",
			"terrain", "dirt",
			"terrain", "dry-mud",
			"terrain", "grass",
...
DefineUnitType("unit-teuton-stables", {
	...
	Variations = {
		...
		{
			"variation-id", "stables-snow-winter",
			"file", "teuton/buildings/stables_snow.png",
			"upgrade-required", "upgrade-masonry",
			"terrain", "dirt",
			"terrain", "dry-mud",
			"terrain", "grass",
...
DefineUnitType("unit-teuton-temple", {
	...
	Variations = {
		...
		},
		{
			...
			"file", "teuton/buildings/church_snow.png",
			"upgrade-required", "upgrade-deity-christian-god",
			"upgrade-forbidden", "upgrade-deity-odin",
			"upgrade-forbidden", "upgrade-deity-thor",
			"upgrade-forbidden", "upgrade-deity-loki",
...
DefineUnitType("unit-teuton-market", {
	...
	Variations = {
		...
		{
			"variation-id", "market-snow-winter",
			"file", "teuton/buildings/market_snow.png",
			"upgrade-required", "upgrade-masonry",
			"terrain", "dirt",
			"terrain", "dry-mud",
			"terrain", "grass",
...
DefineUnitType("unit-teuton-university", {
	...
	Variations = {
		...
		},
		{
			...
			"file", "teuton/buildings/university_snow.png",
			"terrain", "dirt",
			"terrain", "dry-mud",
			"terrain", "grass",
			"terrain", "snow",
...
DefineUnitType("unit-teuton-watch-tower", {
	...
	Variations = {
		...
		},
		{
			...
			"file", "teuton/buildings/watch_tower_snow.png",
			"terrain", "dirt",
			"terrain", "dry-mud",
			"terrain", "grass",
			"terrain", "snow",
...
DefineUnitType("unit-teuton-guard-tower", {
	...
	Variations = {
		...
		},
		{
			...
			"file", "teuton/buildings/guard_tower_snow.png",
			"terrain", "dirt",
			"terrain", "dry-mud",
			"terrain", "grass",
			"terrain", "snow",
...
DefineUnitType("unit-teuton-catapult-tower", {
	...
	Variations = {
		...
		},
		{
			...
			"file", "teuton/buildings/catapult_tower_snow.png",
			"terrain", "dirt",
			"terrain", "dry-mud",
			"terrain", "grass",
			"terrain", "snow",
