...
DefineQuest("the-sack-of-iuvavum", {
	...
	Conditions = function(s)
		...
		if (
			GetPlayerData(trigger_player, "RaceName") == "suebi" and rome_player ~= nil and CPlayer:GetPlayer(trigger_player):IsEnemy(rome_player)
			and (GetNumUnitsAt(rome_player, "unit-latin-town-hall", {4135 - EarthStartX, 960 - EarthStartY}, {4135 - EarthStartX, 960 - EarthStartY}, GetMapLayer("earth")) > 0 or GetNumUnitsAt(rome_player, "unit-teuton-stronghold", {4135 - EarthStartX, 960 - EarthStartY}, {4135 - EarthStartX, 960 - EarthStartY}, GetMapLayer("earth")) > 0)
		) then
			return true
		end
		return false
...
DefineQuest("the-razing-of-opitergium", {
	...
	Conditions = function(s)
		...
		if (
			GetPlayerData(trigger_player, "RaceName") == "suebi" and rome_player ~= nil and CPlayer:GetPlayer(trigger_player):IsEnemy(rome_player)
			and (GetNumUnitsAt(rome_player, "unit-latin-town-hall", {4122 - EarthStartX, 1005 - EarthStartY}, {4122 - EarthStartX, 1005 - EarthStartY}, GetMapLayer("earth")) > 0 or GetNumUnitsAt(rome_player, "unit-teuton-stronghold", {4122 - EarthStartX, 1005 - EarthStartY}, {4122 - EarthStartX, 1005 - EarthStartY}, GetMapLayer("earth")) > 0)
		) then
			return true
		end
		return false
