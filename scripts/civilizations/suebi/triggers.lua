...
AddTrigger("ariovistus-claims-victory-over-the-aedui",
	function()
		for i=0,(PlayerMax - 2) do
			if (GetPlayerData(i, "TotalNumUnitsConstructed") > 0 and FindHero("ariovistus", i) ~= nil and GetFactionExists("sequania") and GetFactionExists("arvernia") and not GetFactionExists("aeduia", true)) then
				trigger_player = i
				return true
			end
		end
