...
DefineUnitType("unit-goblin-worker", {
	...
	Variations = {
		...
		},
		{
			...
			"file-when-loaded", "iron", "goblin/units/goblin_worker_with_gold_spiky_hair.png",
			"file-when-loaded", "mithril", "goblin/units/goblin_worker_with_gold_spiky_hair.png",
			...
			"file-when-loaded", "jewelry", "goblin/units/goblin_worker_with_gold_spiky_hair.png",
			"file-when-loaded", "furniture", "goblin/units/goblin_worker_with_gold_spiky_hair.png",
...
DefineUnitType("unit-goblin-mess-hall", {
	...
	Trains = {"unit-goblin-spearman", "unit-goblin-archer", "unit-goblin-war-machine", "unit-goblin-glider"},
	ButtonKey = "s",
	AiDrops = {"unit-goblin-short-sword", "unit-goblin-broad-sword", "unit-goblin-long-sword", "unit-short-spear", "unit-long-spear", "unit-pike", "unit-composite-bow", "unit-longbow", "unit-hand-cannon", "unit-goblin-wooden-shield", "unit-goblin-rimmed-shield", "unit-goblin-embossed-shield", "unit-boots", "unit-arrows", "unit-barbed-arrows", "unit-bodkin-arrows"},
	Sounds = {
		"help", "basic-goblin-voices-help-town"
