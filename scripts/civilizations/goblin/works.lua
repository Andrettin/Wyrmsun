...
DefineUpgrade("upgrade-work-wid-dweorg", { -- Source: Felix Grendon, "The Anglo-Saxon Charms", 1909, pp. 212-213.
	...
	Work = "scroll",
	Civilization = "goblin", -- actually an Anglo-Saxon charm, but here we put is as a goblin one since this is a charm against a dwarf ("Wid Dweorg" means "Against a Dwarf")
