...
--
--      ui.lua - Define the latin user interface
--
...
wyrmsun.playlist = { "music/loyalists.ogg", "music/war_on_water_1.ogg", "music/war_on_water_2.ogg", "music/war_on_water_3.ogg", "music/heroes_rite.ogg", "music/casualties_of_war.ogg", "music/battle-epic.ogg", "music/battle_theme_a.ogg", "music/the_adventure_begins.ogg" }

function LatinScreen(screen_width, screen_height)
