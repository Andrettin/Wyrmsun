...
DefineUnitType("unit-latin-town-hall", { Name = _("Forum"),
	...
	ButtonKey = "m",
	AiDrops = {"unit-boots"},
	DropAffixes = {"upgrade-item-prefix-flaming", "upgrade-item-prefix-quenching", "upgrade-item-prefix-storm", "upgrade-item-suffix-of-extinguishment", "upgrade-item-suffix-of-fire", "upgrade-item-suffix-of-flame", "upgrade-item-suffix-of-lightning", "upgrade-item-suffix-of-the-serpent", "upgrade-item-suffix-of-the-snail", "upgrade-item-suffix-of-trickery", "upgrade-work-de-bello-gallico", "upgrade-work-meditations", "upgrade-work-notitia-dignitatum"},
	Sounds = {
