...
DefineModifier("upgrade-latin-civilization",
	{"apply-to", "unit_germanic_smithy"}, {"convert-to", "unit-latin-smithy"}
)
...
DefineModifier("upgrade-latin-civilization",
	{"apply-to", "unit_germanic_dock"}, {"convert-to", "unit_latin_dock"}
)

DefineModifier("upgrade-latin-civilization",
	{"apply-to", "unit_teuton_dock"}, {"convert-to", "unit_latin_dock"}
)
