...
function HandleCheats(str)
  local resources = {"gold", "lumber", "oil", "ore", "stone", "coal", "research", "prestige", "timber", "silver", "copper", "grain", "mushrooms", "labor", "fish", "leadership"}
  ...
  elseif (str == "colossus of rhodes") then -- acquire all bronze age technologies
	...
	local bronze_upgrades = {
		...
		"upgrade-goblin-broad-sword", "upgrade-goblin-long-spear", "upgrade-goblin-wood-plow"
	}
