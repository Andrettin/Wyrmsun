...
function HandleCheats(str)
	local resources = {"copper", "lumber", "oil", "ore", "stone", "coal", "research", "prestige", "gold", "silver", "limestone", "furniture", "leather", "grain", "mushrooms", "labor", "fish", "leadership", "trade"}
