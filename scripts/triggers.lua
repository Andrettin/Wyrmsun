	...
	function()
		...
		for i=0,(PlayerMax - 2) do
			...
			elseif (GetPlayerData(i, "UnitTypesCount", "unit-silver-mine") > 0) then
				percent_chance = 2
			elseif (GetPlayerData(i, "UnitTypesCount", "unit-copper-mine") > 0 or GetPlayerData(i, "UnitTypesCount", "unit_iron_mine") > 0 or GetPlayerData(i, "UnitTypesCount", "unit-coal-mine") > 0) then
				percent_chance = 1
			end
