...
--
--      (c) Copyright 2000-2019 by Lutz Sammer, Jimmy Salmon and Andrettin
--
...
--	function() return AiNeed(AiPlatform()) end,
	...
	function() -- certain civilizations acquire serfdom when it becomes available
		if (AiGetRace() == "teuton" or AiGetRace() == "anglo-saxon" or AiGetRace() == "english" or AiGetRace() == "frankish" or AiGetRace() == "suebi" or AiGetRace() == "goth" or AiGetRace() == "norse") then
