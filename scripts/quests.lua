...
Quests = {
	...
	TheMeadOfWisdom = {
		...
		Description = "The sage of Modsognir's clan has been disappeared, taken by two dwarves called Fjalar and Galar. Modsognir has sent Durin to enter their hall, rescue the sage - or what remains of him - and bring the evil pair to justice.\n\nMap: Fjalar's and Galar's Hall\n\nRewards: 2 Dwarven Technology Points, Tomb of Durahn Eikinskjaldi Map.",
		Civilization = "dwarf",
		TechnologyPoints = 2,
