...
Quests = {
	...
	TheMeadOfPoetry = {
		...
		Description = "Word has reached Modsognir that the dwarves Fjalar and Galar have slain our wise clansman Thjodrorir. Modsognir has sent you, Durin, to enter their hall, returning with the sage's remains to give him a proper burial, and bringing the evil pair to the clan's justice.\n\nMap: Fjalar's and Galar's Hall\n\nRewards: 3 Dwarven Technology Points.",
		Civilization = "dwarf",
		TechnologyPoints = 2,
