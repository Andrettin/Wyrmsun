...
--
--      (c) Copyright 1998-2021 by Lutz Sammer, Pali Rohár and Andrettin
--
...
function SinglePlayerTriggers()
	AddTrigger("default-defeat",
		function()
			...
			if (total_units <= 0 and PlayerHasObjective(GetThisPlayer(), "- Defeat the Norlunds") == false and (GameCycle > 1000 or mapinfo.description ~= "Caverns of Flame" or GetPlayerData(GetThisPlayer(), "Name") ~= "shinsplitter_clan")) then
				return true
			else
				return false
			end
...
function LoadDataDirectories(directory)
	local data_directories = {"button_levels", "time_of_day_schedules", "seasons", "season_schedules", "missile_types", "spells", "terrain_types", "animations", "currencies", "civilizations", "factions", "unit_types", "upgrades", "deity_domains", "schools_of_magic", "religions", "pantheons", "deities", "map_templates", "sites", "characters", "buttons", "campaigns"}
