...
DefineConversibleSkinColors("white")
	...
	if (wyr.preferences.ShowTips and not IsReplayGame() and not IsNetworkGame()) then
		...
		if (GetArrayIncludes(wyr.preferences.TipsShown, "Krieger") == false) then
			AddTrigger("tip-krieger",
				...
				function()
					Tip("Kregar", "The Kregar is the melee infantry unit of the Suebi and Teuton civilizations, replacing the Erala.")
					return false
				end
			)
		end
