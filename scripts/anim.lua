...
--
--      (c) Copyright 2000-2021 by Josh Cogliati, Lutz Sammer, Jimmy Salmon, Pali Rohár and Andrettin
--
...
ShipMove = {
	...
	"label speed_8", -- 16 / (8 / 10) = 20 waits
	"frame 0", "move 2", "wait 1", "frame 0", "move 2", "wait 1",
	"frame 0", "move 1", "wait 1", "move 1", "wait 1", "frame 0", "move 2", "wait 1",
	"frame 0", "move 2", "wait 1", "frame 0", "move 2", "wait 1",
	"frame 0", "move 1", "wait 1", "move 1", "wait 1", "frame 0", "move 2", "wait 1",
	"frame 0", "move 2", "wait 1", "frame 0", "move 2", "wait 1",
	"frame 0", "move 1", "wait 1", "move 1", "wait 1", "frame 0", "move 2", "wait 1",
	"frame 0", "move 2", "wait 1", "frame 0", "move 2", "wait 1",
	"frame 0", "move 1", "wait 1", "move 1", "wait 1", "frame 0", "move 2", "goto end",
	"label speed_9", -- 16 / (9 / 10) = c. 18 waits
	"frame 0", "move 2", "wait 1", "frame 0", "move 2", "wait 1",
	"frame 0", "move 2", "wait 1", "frame 0", "move 2", "wait 1",
	"frame 0", "move 2", "wait 1", "frame 0", "move 2", "wait 1",
...
DefineAnimations("animations-minecart", {
	...
	Move = {
		...
		"if-var v.Speed.Value == 2 speed_2",
		"if-var v.Speed.Value <= 5 speed_5",
		"if-var v.Speed.Value == 6 speed_6",
		"if-var v.Speed.Value == 7 speed_7",
		"if-var v.Speed.Value >= 8 speed_8",
		...
		"frame 0", "goto end",
		"label speed_2", -- 16 / (2 / 10) = 80 waits
		"frame 0", "move 5", "wait 12", "frame 5", "move 5", "wait 13",
		"frame 0", "move 6", "wait 14", "frame 5", "move 6", "wait 15",
		"frame 0", "move 5", "wait 12", "frame 5", "move 5", "wait 13",
		"frame 0", "goto end",
		"label speed_5", -- 16 / (5 / 10) = 32 waits
