...
local RatStill = {
	...
	"label set_variation", "random-goto 33 variation_1", "random-goto 50 variation_2", "goto variation_3",
	"label variation_1", "set-var GraphicsVariation.Value = 1",
	"frame 0", "wait 4", "random-goto 99 no-rotate", "random-rotate 1", "goto no-rotate",
	"label variation_2", "set-var GraphicsVariation.Value = 2",
	"frame 60", "wait 4", "random-goto 99 no-rotate", "random-rotate 1", "goto no-rotate",
	"label variation_3", "set-var GraphicsVariation.Value = 3",
	"frame 120", "wait 4", "random-goto 99 no-rotate", "random-rotate 1", "goto no-rotate",
...
local RatMove = {"unbreakable begin",
	...
	"label variation_2",
	"frame 60","move 1", "wait 2", "frame 65", "move 1", "wait 1",
	"frame 65", "move 1", "wait 2", "frame 70", "move 1", "wait 1",
	"frame 70", "move 1", "wait 1", "frame 60", "move 1", "wait 1",
	"frame 60", "move 1", "wait 2", "frame 75", "move 1", "wait 1",
	"frame 75", "move 1", "wait 2", "frame 80", "move 1", "wait 1",
	"frame 80", "move 1", "wait 1", "frame 60",
	"frame 60","move 1", "wait 2", "frame 65", "move 1", "wait 1",
	"frame 65", "move 1", "wait 2", "frame 70", "move 1", "wait 1",
	"frame 70", "move 1", "wait 1", "frame 60", "move 1", "wait 1",
	"frame 60", "move 1", "wait 2", "frame 75", "move 1", "wait 1",
	...
	"frame 60", "move 1", "wait 2", "frame 65", "move 1", "wait 1",
	"frame 65", "move 1", "wait 2", "frame 70", "move 1", "wait 1",
	"frame 70", "move 1", "wait 1", "frame 60", "wait 1",
	"frame 60", "move 1", "wait 2", "frame 75", "move 1", "wait 1",
	"frame 75", "move 1", "wait 2", "frame 80", "move 1", "wait 1",
	"frame 80", "move 1", "wait 1", "frame 60", "goto end",
	"label variation_3",
	"frame 120","move 1", "wait 2", "frame 125", "move 1", "wait 1",
	"frame 125", "move 1", "wait 2", "frame 130", "move 1", "wait 1",
	"frame 130", "move 1", "wait 1", "frame 120", "move 1", "wait 1",
	"frame 120", "move 1", "wait 2", "frame 135", "move 1", "wait 1",
	"frame 135", "move 1", "wait 2", "frame 140", "move 1", "wait 1",
	"frame 140", "move 1", "wait 1", "frame 120",
	"frame 120","move 1", "wait 2", "frame 125", "move 1", "wait 1",
	"frame 125", "move 1", "wait 2", "frame 130", "move 1", "wait 1",
	"frame 130", "move 1", "wait 1", "frame 120", "move 1", "wait 1",
	"frame 120", "move 1", "wait 2", "frame 135", "move 1", "wait 1",
	...
	"frame 120", "move 1", "wait 2", "frame 125", "move 1", "wait 1",
	"frame 125", "move 1", "wait 2", "frame 130", "move 1", "wait 1",
	"frame 130", "move 1", "wait 1", "frame 120", "wait 1",
	"frame 120", "move 1", "wait 2", "frame 135", "move 1", "wait 1",
	"frame 135", "move 1", "wait 2", "frame 140", "move 1", "wait 1",
	"frame 140", "move 1", "wait 1", "frame 120", "goto end",
...
local RatDeath = {"unbreakable begin",
	...
	"label variation_2",
	"frame 105", "wait 3", "frame 110", "wait 3", "frame 115", "wait 100", "frame 115", "goto end",
	"label variation_3",
...
DefineAnimations("animations-rat", {
  ...
  Attack = {"unbreakable begin",
	...
	"frame 100", "attack", "sound axe-attack", "wait 5", "frame 60", "wait 10", "frame 60",
	"label variation_3",
	"frame 145", "wait 3", "frame 150", "wait 3", "frame 155", "wait 3",
	"frame 160", "attack", "sound axe-attack", "wait 5", "frame 120", "wait 10", "frame 120",
	"label end", "unbreakable end", "wait 1",},
  Death = RatDeath,
})
...
local GryphonStill = {
	...
	"if-var v.GraphicsVariation.Value == 1 variation_1",
	"if-var v.GraphicsVariation.Value == 2 variation_2",
	"label set_variation", "random-goto 66 variation_1", "goto variation_2",
	"label variation_1", "set-var GraphicsVariation.Value = 1",
	"frame 0", "wait 6", "frame 5", "wait 6", "frame 10", "wait 6", "frame 15", "goto end",
	"label variation_2", "set-var GraphicsVariation.Value = 2",
	"frame 65", "wait 6", "frame 70", "wait 6", "frame 75", "wait 6", "frame 80", "goto end",
	"label end", "wait 6",
}
local GryphonMove = {"unbreakable begin",
	...
	"frame 15", "move 3", "wait 1", "frame 0", "move 3", "goto end",
	"label variation_2",
	"frame 65", "wait 1", "frame 65", "move 3", "wait 1",
	"frame 65", "move 3", "wait 1", "frame 70", "move 3", "wait 1",
	"frame 70", "move 2", "wait 1", "frame 70", "move 3", "wait 1",
	"frame 75", "move 3", "wait 1", "frame 75", "move 3", "wait 1",
	"frame 75", "move 3", "wait 1", "frame 80", "move 3", "wait 1",
	"frame 80", "move 3", "wait 1", "frame 65", "move 3", "goto end",
	"label end", "unbreakable end", "wait 1",}
local GryphonDeath = {"unbreakable begin",
	...
	"frame 60", "goto end",
	"label variation_2",
	"frame 100", "wait 5", "frame 105", "wait 5", "frame 110", "wait 5",
	"frame 115", "wait 5", "frame 120", "wait 5", "frame 125", "wait 5",
	"frame 125", "goto end",
	"label end", "unbreakable end", "wait 1",}
...
DefineAnimations("animations-gryphon", {
  ...
  Attack = {"unbreakable begin",
	...
	"frame 0", "goto end",
	"label variation_2",
	"frame 65", "wait 6", "frame 70", "wait 6",
	"frame 75", "wait 6", "frame 80", "wait 6", "frame 80", "wait 1",
	"frame 85", "wait 6", "frame 90", "wait 6",
	"frame 95", "attack", "sound claw-attack", "wait 8",
	"frame 65", "goto end",
	"label end", "unbreakable end", "wait 1", },
  Death = GryphonDeath,
})
