...
DefineProvince("Cornwall", {
	...
	HistoricalOwners = {
		...
		1560, "anglo-saxon", "england" -- Political situation in Europe in 1560 AD; Source: William R. Shepherd, "Historical Atlas", 1911, pp. 118-119.
	},
	HistoricalClaims = {
		43, "latin", "rome"
	},
...
DefineProvince("East Anglia", {
	World = "Earth",
	FactionCulturalNames = {
		"anglo-saxon", "england", "East Anglia"
	},
	Tiles = {
...
--		{119, 29}, {119, 30}, {120, 29}, {120, 30}, {121, 28}, {121, 29}, {121, 30}, {122, 29}, {122, 30}, {122, 31}, {123, 29}, {123, 30}, {124, 29}, {125, 29}, -- old map
		...
		{481, 117}, {481, 118}, {481, 119}, {481, 120},
		{482, 117}, {482, 118}, {482, 119}, {482, 120},
		{483, 116}, {483, 117}, {483, 118}, {483, 119}, {483, 120},
		{484, 115}, {484, 116}, {484, 117}, {484, 118}, {484, 119}, {484, 120}, {484, 121},
		{485, 115}, {485, 116}, {485, 117}, {485, 118}, {485, 119}, {485, 120}, {485, 121},
		{486, 115}, {486, 116}, {486, 117}, {486, 118}, {486, 119}, {486, 120}, {486, 121},
		{487, 115}, {487, 116}, {487, 117}, {487, 118}, {487, 119}, {487, 120}, {487, 123},
		{488, 115}, {488, 117}, {488, 118}, {488, 119}, {488, 120}, {488, 123},
...
DefineProvince("Galloway", {
	...
	HistoricalOwners = {
		...
		1560, "anglo-saxon", "scotland" -- Political situation in Europe in 1560 AD; Source: William R. Shepherd, "Historical Atlas", 1911, pp. 118-119.
	},
	HistoricalClaims = {
		80, "latin", "rome"
	},
...
DefineProvince("Highland Scotland", {
	...
	FactionCulturalNames = {
		"anglo-saxon", "england", "Highland Scotland",
		"celt", "scot-tribe", "Highland Scotland",
		"anglo-saxon", "scotland", "Highland Scotland"
	},
	Tiles = {
...
DefineProvince("Holstein", {
	...
	Tiles = {
		...
		{509, 101}, {509, 102}, {509, 103},
		{510, 101}, {510, 102}, {510, 103}
	},
...
DefineProvince("Khersonska", {
	...
	Tiles = {
		...
		{572, 123}, {572, 124},
		{573, 123}, {573, 124},
		{574, 121}, {574, 122}, {574, 123}, {574, 124},
		{575, 121}, {575, 122}, {575, 123}, {575, 124},
		{576, 121}, {576, 122}, {576, 123}, {576, 124},
		{577, 121}, {577, 122}, {577, 123}, {577, 124},
		{578, 122}, {578, 123}, {578, 124}
	},
...
DefineProvince("Lothian", { -- includes Borders
	...
	Claims = {
		"celt", "otalini-tribe",
		"anglo-saxon", "scotland" -- should be English
	},
	HistoricalOwners = {
...
DefineProvince("Northumberland", {
	...
	FactionCulturalNames = {
		...
		"anglo-saxon", "england", "Northumberland"
	},
	Tiles = {
		{473, 99},
...
DefineProvince("Orkney", {
	...
	Claims = {
		"norse", "orkney",
		"anglo-saxon", "scotland" -- should be English-cultured instead
	},
	HistoricalOwners = {
...
DefineProvince("Strathclyde", {
	...
	FactionCulturalNames = {
		"anglo-saxon", "england", "Strathclyde"
	},
	Tiles = {
		{466, 97}, {466, 98},
		{467, 97}, {467, 98},
...
--		{139, 28}, {140, 27}, {140, 28}, {140, 29}, {141, 27}, {141, 28}, {141, 29}, {141, 30}, {142, 27}, {142, 28}, {142, 29}, {142, 30}, {143, 27}, {143, 28}, {143, 29}, {143, 30}, {144, 27}, {144, 28}, {144, 29}, {144, 30}, {144, 31}, {145, 28}, {145, 29}, {145, 30}, {146, 28}, {146, 29}, {146, 30}, {147, 28}, {147, 29}, -- old map
		...
		{571, 109}, {571, 110}, {571, 111}, {571, 112}, {571, 113}, {571, 114}, {571, 115}, {571, 116}, {571, 117}, {571, 118}, {571, 119}, {571, 120}, {571, 121}, {571, 122},
		{572, 108}, {572, 109}, {572, 110}, {572, 111}, {572, 112}, {572, 113}, {572, 114}, {572, 115}, {572, 116}, {572, 117}, {572, 118}, {572, 119}, {572, 120}, {572, 121}, {572, 122},
		{573, 108}, {573, 109}, {573, 110}, {573, 111}, {573, 112}, {573, 113}, {573, 114}, {573, 115}, {573, 116}, {573, 117}, {573, 118}, {573, 119}, {573, 120}, {573, 121}, {573, 122},
		{574, 108}, {574, 109}, {574, 110}, {574, 111}, {574, 112}, {574, 113}, {574, 114}, {574, 115}, {574, 116}, {574, 117}, {574, 118}, {574, 119}, {574, 120},
		{575, 108}, {575, 109}, {575, 110}, {575, 111}, {575, 112}, {575, 113}, {575, 114}, {575, 115}, {575, 116}, {575, 117}, {575, 118}, {575, 119}, {575, 120},
		{576, 108}, {576, 109}, {576, 110}, {576, 111}, {576, 112}, {576, 113}, {576, 114}, {576, 115}, {576, 116}, {576, 117}, {576, 118}, {576, 119}, {576, 120},
		{577, 110}, {577, 111}, {577, 112}, {577, 113}, {577, 114}, {577, 115}, {577, 116}, {577, 117}, {577, 118}, {577, 119}, {577, 120},
		{578, 110}, {578, 111}, {578, 112}, {578, 113}, {578, 114}, {578, 115}, {578, 116}, {578, 117}, {578, 118}, {578, 119}, {578, 120}, {578, 121},
