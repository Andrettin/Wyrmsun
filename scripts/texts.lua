...
--	YnglingaSaga = {
--		Title = "~!Ynglinga Saga",
--		Author = "Snorri Sturluson (translated by Samuel Laing)",
--		Year = 1844,
--		Publisher = "London",
--		CopyrightNotice = "This text is in the public domain in the United States because it was published prior to 1923. It is also in the public domain in Austria, as the last surviving author has died more than 70 years ago (in 1868).",
--		Notes = "This text was originally published as part of Samuel Laing's translation of the Heimskringla.",
--		Chapters = {
--		}
--	},
	--[[
	TeutonicMythAndLegend = {
		Title = "~!Teutonic Myth & Legend",
		Author = "Donald A. Mackenzie",
		Year = 1912,
		Publisher = "London: Gresham Publications",
		CopyrightNotice = "This text is in the public domain in the United States because it was published prior to 1923. It is also in the public domain in Austria, as the last surviving author has died more than 70 years ago (in 1936).",
--		Notes = "[Wyrmsun Note: Only selected chapters of this work are included here. Specifically, those in which dwarves are mentioned.]",
		InitialPage = 44,
		Chapters = {
			TheWinterWar = {
