...
DefineMapTemplate("outskirts-of-kal-kartha", { -- From Battle for Wesnoth: The Hammer of Thursagan (Fear)
	...
	TerrainFile = "scripts/map_templates/nidavellir/outskirts_of_kal_kartha.map",
	OverlayTerrainFile = "scripts/map_templates/nidavellir/outskirts_of_kal_kartha_overlay.map"
})
