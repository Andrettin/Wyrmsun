...
SetMapTemplateUnit("crucible-of-steel", "unit-dwarven-smithy", "whitesteel_clan", {6, 7})
SetMapTemplateUnit("crucible-of-steel", "unit-minecart", "whitesteel_clan", {5, 13})
SetMapTemplateUnit("crucible-of-steel", "unit-minecart", "whitesteel_clan", {5, 15})
SetMapTemplateUnit("crucible-of-steel", "unit-minecart", "whitesteel_clan", {5, 17})
