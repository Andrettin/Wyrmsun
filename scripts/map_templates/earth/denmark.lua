...
-- Leidre / Lejre
SetMapTemplateCulturalSettlementName("earth", "Leidre", {4112, 784}, "germanic") -- should be a rendeing of Lejre in Proto-Germanic instead
SetMapTemplateCulturalSettlementName("earth", "Leidre", {4112, 784}, "norse")
