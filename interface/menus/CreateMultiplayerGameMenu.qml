...
MenuBase {
	...
	LargeButton {
		...
		onClicked: {
			wyrmgus.call_lua_command("RunServerMultiGameMenu(\"" + escape_string(selected_map.presentation_filepath) + "\", \"" + escape_string(selected_map.name) + "\", " + selected_map.player_count + ");")
		}
	}
