...
Item {
	...
	readonly property int horizontal_padding: 8 * wyrmgus.scale_factor
	readonly property int vertical_padding: 16 * wyrmgus.scale_factor
	...
	readonly property int parent_text_height: parent_text_height_reference.contentHeight + 2 * wyrmgus.scale_factor * 2
	...
	TinyText {
		...
		anchors.topMargin: 2 * wyrmgus.scale_factor
		anchors.horizontalCenter: parent.horizontalCenter
		text: name
		width: parent.width
	...
	Rectangle {
		id: horizontal_line
		width: get_base_width() + 2 * wyrmgus.scale_factor
		height: 2 * wyrmgus.scale_factor
		color: "gray"
