...
* Major
- Overhauled the game, porting it to a Godot a project, with the game's inner logic becoming a C++ module.
...
- All Earth scenarios now use the same Earth map, which has been increased in size to 384x384.
