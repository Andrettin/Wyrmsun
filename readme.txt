...
/sounds/misc/ship_move.wav (licensed under the CC-BY-SA 3.0)
/sounds/misc/ship_selected.wav (licensed under the CC-BY-SA 3.0)
...
- Siege engines no longer attack a target if that will hurt a friendly unit.
